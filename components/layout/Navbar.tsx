    ...
    >
      <nav className="luxury-container flex h-20 items-center justify-between">
        ...
        <div className="hidden items-center gap-2 md:flex">
          <button aria-label="Search" className="rounded-full p-3 transition hover:bg-forest/5">
            <Search size={19} />
          </button>
          <button aria-label="Wishlist" className="rounded-full p-3 transition hover:bg-forest/5">
            <Heart size={19} />
          </button>
          <button
            aria-label="Cart"
        ...
        <div className="fixed inset-0 z-50 bg-pearl/96 p-6 backdrop-blur-xl md:hidden">
          ...
          <div className="mt-12 grid gap-6">
            ...
            <button
              ...
              className="mt-4 flex items-center gap-3 text-lg"
            >
